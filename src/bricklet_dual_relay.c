...
typedef void (*MonoflopDone_CallbackFunction)(uint8_t, bool, void *);
...
void dual_relay_register_callback(DualRelay *dual_relay, int16_t id, void *callback, void *user_data) {
